...
class Show2(BoxLayout):
    pass
class ShowVoiture2(GridLayout):
    def __init__(self,**kwargs):
        super(ShowVoiture2,self).__init__(**kwargs)
        self.cols = 3
        self.btns=[]
    ...
    def afficher(self):
        ...
        self.liste = App.get_running_app().manager.ids.show.ids.boxlayoutshow.ids.show2.ids.liste
        id_nom = []
        ...
        app.manager.liste_voiture2 = id_nom
